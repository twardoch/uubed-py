...
class TestVectorDBConnectors:
    ...
    def test_import_vectordb_connectors(self):
        ...
        from uubed.integrations.vectordb import VectorDBConnector, get_connector
    ...
    def test_mock_chroma_connector(self):
        ...
        class MockChromaCollection:
            ...
            def add(self, embeddings, documents, metadatas, ids):
                for emb, doc, meta, id_ in zip(embeddings, documents, metadatas, ids, strict=False):
                    self.data.append({
                        "id": id_,
                        "embedding": emb,
                        "document": doc,
...
class TestGPUIntegration:
    ...
    def test_import_gpu_module(self):
        ...
        from uubed.gpu import get_gpu_info, is_gpu_available
